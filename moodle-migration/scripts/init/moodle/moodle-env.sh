...
# Paths
export MOODLE_BASE_DIR="${ROOT_DIR}/moodle"
export MOODLE_CONF_FILE="${MOODLE_BASE_DIR}/config.php"

# Moodle persistence configuration
export MOODLE_VOLUME_DIR="${VOLUME_DIR}/moodle"
export MOODLE_DATA_DIR="${MOODLE_DATA_DIR:-${VOLUME_DIR}/moodledata}"
...
export MOODLE_PASSWORD="${MOODLE_PASSWORD:-moodle}" # only used during the first initialization
...
export MOODLE_DATABASE_TYPE="${MOODLE_DATABASE_TYPE:-pgsql}" # only used during the first initialization
MOODLE_DATABASE_HOST="${MOODLE_DATABASE_HOST:-"${MARIADB_HOST:-}"}"
export MOODLE_DATABASE_HOST="${MOODLE_DATABASE_HOST:-moodle-postgres}" # only used during the first initialization
MOODLE_DATABASE_PORT_NUMBER="${MOODLE_DATABASE_PORT_NUMBER:-"${MARIADB_PORT_NUMBER:-}"}"
export MOODLE_DATABASE_PORT_NUMBER="${MOODLE_DATABASE_PORT_NUMBER:-5432}" # only used during the first initialization
export MOODLE_DATABASE_NAME="${MOODLE_DATABASE_NAME:-moodle}" # only used during the first initialization
export MOODLE_DATABASE_USER="${MOODLE_DATABASE_USER:-moodle}" # only used during the first initialization
